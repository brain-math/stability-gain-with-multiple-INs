%% Code to reproduce Fig. 6 & Fig. S2 of Bos, Miehl et al., 2024
clear all
...
wEE_vec=[0.5, 0.8]; % non-ISN (1-wEE*bE>0) & ISN regime (1-wEE*bE<0) [Fig. 6 is non-ISN and Fig. S2 is ISN regime]
